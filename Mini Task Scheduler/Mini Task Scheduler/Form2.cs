...
{
    public partial class frmMessView : Form
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataAdapter da;
        ...
        private void frmMessView_Load(object sender, EventArgs e)
        {
            oldtitle = title;
            ...
            tb_MTitle.Text = messtitle.ToString();
        ...
        private void tpTrigger_Click(object sender, EventArgs e)
        {
